...
ids=sp.array(ids)
money=[sts.lognorm.rvs(.75)*100000 for n in range(0,numOfP)]
money=sp.array(money)
ability=[(1/(sts.lognorm.rvs(.5)+1)) for n in range(0,numOfP)]
ability=sp.array(ability)
ids,money,ability
p=[]
