...
ids=sp.array([range(0,numOfP),np.zeros(numOfP)],dtype='int64')
#People object
peo=[];
...
peo=np.array(peo,dtype=[('id','int64'),('value','float64'),('ability','float32'),('entropy','float32'),[('ids','int64'),('helped','int64')]])
np.sum(peo['value'])
# plt.plot(p[1])
# %%
