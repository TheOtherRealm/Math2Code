...
#%%
ids=[uuid.uuid1().int for n in range(0,10)]
# money=sp.array([(sts.lognorm.rvs(.75)*100000 for n in range(0,10))])
# ability=sp.array([((1/(sts.lognorm.rvs(.5)+1)) for n in range(0,10))])
ids#,money,ability
# %%
