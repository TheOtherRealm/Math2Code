...
ids=np.array(range(0,numOfP),dtype=[('id','int64')])
#People object
peo=[];
...
# peo
peo=np.array(peo,dtype=[('id','int64'),('value','float64'),('ability','float32'),('helpNeeded','float32'),('helpOut','object'),('helpIn','object')])
# np.sum(peo['value'])
# plt.plot(p[1])
# %%
